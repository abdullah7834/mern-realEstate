...
function CreateListing() {
  ...
  return (
    <main className="p-3 max-w-7xl mx-auto">
      ...
      <form className="flex flex-col lg:flex-row gap-4" onSubmit={handleSubmit}>
            ...
            formData.imageUrls.map((url, index) => (
              ...
              >
                ...
                <button
                  ...
                  className="p-3 text-red-700 rounded-lg uppercase hover:opacity-95 disabled:opacity-85 cursor-pointer"
                >
                  Delete
                </button>
              </div>
